  ...
  return (
    <header className='flex justify-between h-24 items-center px-8 border-b'>
        ...
        <div className="flex items-center gap-8  *:rounded-md *:px-4 *:py-2 *:font-semibold *:duration-300 ">
         <Link href="/new" className='hidden md:flex bg-primary hover:bg-primary-hover text-white  items-center gap-2'>
         ...
         </Link>
         {
          !session?.user && (
            <>
            <button className='hidden md:flex border text-gray-600 border-gray-400 hover:bg-gray-300 hover:text-black items-center gap-2 '>Sign up</button>
         <button onClick={()=>signIn("google")} className=' hidden md:flex border-2 border-primary text-primary hover:bg-primary hover:text-white items-center gap-2 '>
